...
expa_dict = {
    '3.16' : datetime.datetime(year,3,16,18,45),
    '6.16' : datetime.datetime(year,6,15,18,45),
    '9.16' : datetime.datetime(year,9,15,18,45),
    '12.16': datetime.datetime(year,12,15,18,45),
}

opt_expa_dict = {
    '1': datetime.datetime(year,1,21,18,45),
    '2': datetime.datetime(year,2,18,18,45),
    '3': datetime.datetime(year,3,15,18,45),
    '4': datetime.datetime(year,4,21,18,45),
    '5': datetime.datetime(year,5,19,18,45),
    '6': datetime.datetime(year,6,15,18,45),
    '7': datetime.datetime(year,7,21,18,45),
    '8': datetime.datetime(year,8,18,18,45),
    '9': datetime.datetime(year,9,15,18,45),
    '10': datetime.datetime(year,10,20,18,45),
    '11': datetime.datetime(year,11,17,18,45),
    '12': datetime.datetime(year,12,15,18,45),
}


dbname = 'sqlite:///Si2016.db'
    ...
    for record in records:
        ...
        if record.timestamp.hour == hour and record.timestamp.minute == minute:
            ...
            if contract_expa in expa_dict.keys():
                ...
                if (expa_dict[contract_expa] - record.timestamp).days <= 91:
